                          ...
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div key={product.id} className="group relative">
                                <div className=" min-h- 60 aspect-h-1 aspect-w-1 w-full border-solid border-2 p-2 overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                                  <img
